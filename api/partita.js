...
const COMPETIZIONI = {
  "ita.1": { nome: "Serie A", paese: "Italia" },
  "ita.2": { nome: "Serie B", paese: "Italia" },
  "ita.coppa_italia": { nome: "Coppa Italia", paese: "Italia" },
  "ita.fifa": { nome: "Nazionale Italia", paese: "Italia" },
  "uefa.champions": { nome: "Champions League", paese: "Europa" },
  "uefa.europa": { nome: "Europa League", paese: "Europa" },
  "uefa.europa.conf": { nome: "Conference League", paese: "Europa" },
  "fra.1": { nome: "Ligue 1", paese: "Francia" },
  "esp.1": { nome: "La Liga", paese: "Spagna" },
  "eng.1": { nome: "Premier League", paese: "Inghilterra" },
  "ksa.1": { nome: "Saudi Pro League", paese: "Arabia Saudita" },
  "por.1": { nome: "Liga Portugal", paese: "Portogallo" },
  "ned.1": { nome: "Eredivisie", paese: "Paesi Bassi" },
  "ger.1": { nome: "Bundesliga", paese: "Germania" }
};
...
function nomeGiocatore(p) {
  ...
  return ultimoCognome(nomeCompletoAtleta(atleta));
}
...
function creaSostituzioni(plays) {
  ...
  for (const p of plays) {
    ...
    if (
      ...
      const lista = p.athletesInvolved;
    ...
    risultati.push({
      minuto: minutoEvento(p),
      entrato: cognomeAtleta(entrato),
      uscito: cognomeAtleta(uscito),
      squadra: squadraEvento(p)
    });
  }
...
function trovaStatistica(lista, possibiliNomi) {
...
function getFaseTurno(data, competition) {
  ...
  function analizza(obj, profondita) {
    if (
      obj === null ||
      obj === undefined ||
      profondita > 12
  ...
  /* Prima la singola partita */
  analizza(
    competition,
    0
  );

  /* Poi tutta la risposta ESPN */
  if (valori.length === 0) {
    analizza(
      data,
      0
